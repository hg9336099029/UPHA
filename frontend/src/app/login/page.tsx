    ...
    <main className="flex-1 bg-[#fcfbf9] min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-10">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-[#111827] rounded-full mb-5 shadow-lg">
            <Image src="/logo.png" alt="UPHA" width={40} height={40} className="object-contain" />
          </div>
