...
export default function PlayerRegistrationHero() {
  return (
    <div className="bg-[#111827] text-white pt-12 pb-16">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <h1 className="font-heading text-6xl md:text-7xl font-bold uppercase tracking-wide mb-6">
          PLAYER <span className="text-accent">REGISTRATION</span>
        </h1>
        
        {/* Subtext */}
        <p className="font-serif italic text-xl md:text-2xl text-gray-300 max-w-2xl mb-12 leading-relaxed">
          Become an officially recognised UPHA player. Get your federation ID, district affiliation, and eligibility to compete in state and national tournaments.
        </p>
        ...
        <div className="flex flex-wrap gap-12 mt-6">
          <div>
            ...
            <div className="font-bold font-mono text-sm tracking-wider">REF / PLR-2026</div>
          </div>
          <div>
            <div className="text-[10px] font-bold tracking-widest text-gray-500 uppercase mb-2">ANNUAL FEE</div>
            <div className="font-bold font-mono text-sm tracking-wider">₹ 111</div>
          </div>
          <div>
          ...
          <div>
            ...
            <div className="font-bold font-mono text-sm tracking-wider">Age 12 - 35</div>
          </div>
        </div>
