      ...
      <div className="bg-[#111827] text-white shadow-sm rounded-sm p-6">
        ...
        <ul className="space-y-4">
          <li className="flex gap-3 items-start">
            ...
            <div className="text-xs text-gray-300 leading-relaxed">Official UPHA Academy Unit status</div>
          </li>
          <li className="flex gap-3 items-start">
            <Check className="w-4 h-4 text-accent shrink-0 mt-0.5" />
          ...
          <li className="flex gap-3 items-start">
            <Check className="w-4 h-4 text-accent shrink-0 mt-0.5" />
            <div className="text-xs text-gray-300 leading-relaxed">Academy logo and contact listed on UPHA website</div>
          </li>
          <li className="flex gap-3 items-start">
            <Check className="w-4 h-4 text-accent shrink-0 mt-0.5" />
