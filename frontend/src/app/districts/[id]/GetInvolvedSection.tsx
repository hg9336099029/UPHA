    ...
    <div className="mb-24">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between border-b border-gray-200 pb-4 mb-12">
        ...
        <div className="text-[10px] font-bold tracking-widest text-gray-400 uppercase mt-2 md:mt-0">
          REGISTER THROUGH ALIGARH HANDBALL ASSOCIATION
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="bg-white border border-gray-200 rounded-sm p-8 shadow-sm hover:shadow-md transition-shadow flex flex-col h-full">
          ...
          <p className="text-xs text-gray-500 leading-relaxed mb-8 flex-1">
            Affiliate yourself as a handball player under the Aligarh district unit. Annual fee ₹ 111.
          </p>
          <div className="border-t border-gray-100 pt-4 mt-auto">
            <Link href="/register/player" className="text-[9px] font-bold tracking-widest text-accent uppercase hover:text-primary transition-colors">
        ...
        <div className="bg-white border border-gray-200 rounded-sm p-8 shadow-sm hover:shadow-md transition-shadow flex flex-col h-full">
          ...
          <div className="border-t border-gray-100 pt-4 mt-auto">
            <Link href="/register/coach" className="text-[9px] font-bold tracking-widest text-accent uppercase hover:text-primary transition-colors">
        ...
        <div className="bg-white border border-gray-200 rounded-sm p-8 shadow-sm hover:shadow-md transition-shadow flex flex-col h-full">
          ...
          <div className="border-t border-gray-100 pt-4 mt-auto">
            <Link href="/register/referee" className="text-[9px] font-bold tracking-widest text-accent uppercase hover:text-primary transition-colors">
