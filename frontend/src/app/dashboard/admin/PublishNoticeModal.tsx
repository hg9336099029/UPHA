      ...
      <div className="flex justify-between items-start p-6 border-b border-gray-100">
        <div>
          ...
          <h2 className="font-heading text-3xl font-bold uppercase tracking-wide text-[#111827]">
            PUBLISH <span className="text-[#d97c55]">NOTICE</span>
          </h2>
        </div>
      </div>
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-[9px] font-bold tracking-widest text-gray-800 uppercase mb-1.5">
                  NOTICE TITLE <span className="text-[#d97c55]">*</span>
                </label>
                <input
                  type="text"
                  required
              ...
              <div>
                ...
                <textarea
                  required
                  rows={4}
                  placeholder="Full notice content shown on dashboards and the website..."
