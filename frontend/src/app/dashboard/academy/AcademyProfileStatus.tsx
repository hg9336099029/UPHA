      ...
      <div className="flex items-center gap-6 mb-8">
        <div className="relative w-16 h-16 shrink-0">
          <svg className="w-full h-full transform -rotate-90" viewBox="0 0 36 36">
            ...
            {/* Progress Circle (75%) */}
            <circle cx="18" cy="18" r="15.915" fill="none" stroke="#d97c55" strokeWidth="3" strokeDasharray="75, 100" />
          </svg>
          <div className="absolute inset-0 flex items-center justify-center">
            <span className="font-heading text-lg font-bold text-primary">75%</span>
          </div>
        </div>
        <div>
          <div className="font-bold text-sm text-gray-800 mb-1">Almost complete</div>
          <div className="text-xs text-gray-500">2 items remaining to reach 100%</div>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col gap-4">
        ...
        <div className="flex items-center justify-between border-b border-gray-100 pb-3">
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm text-gray-600">Academy logo</span>
          </div>
        ...
        <div className="flex items-center justify-between border-b border-gray-100 pb-3">
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm text-gray-600">Affiliation fee paid</span>
          </div>
          <span className="text-[9px] font-bold tracking-widest text-emerald-600 uppercase">DONE</span>
        </div>
